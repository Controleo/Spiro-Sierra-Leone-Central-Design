...
var lyr_SierraLeonePlan_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/SierraLeonePlan_3_0.png" /> 12 Racks<br />\
    <img src="styles/legend/SierraLeonePlan_3_1.png" /> 30 Racks<br />\
    <img src="styles/legend/SierraLeonePlan_3_2.png" /> 6 Racks<br />\
    <img src="styles/legend/SierraLeonePlan_3_3.png" /> Fast Chargers<br />\
    <img src="styles/legend/SierraLeonePlan_3_4.png" /> <br />' });

lyr_OpenStreetMap_0.setVisible(true);lyr_GoogleHybrid_1.setVisible(true);lyr_Freetown_2.setVisible(true);lyr_SierraLeonePlan_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_GoogleHybrid_1,lyr_Freetown_2,lyr_SierraLeonePlan_3];
...
lyr_SierraLeonePlan_3.set('fieldAliases', {'fid': 'fid', 'Location': 'Location', 'No of Racks': 'No of Racks', 'review': 'review', 'power available': 'power available', 'Station ID': 'Station ID', 'longitude': 'longitude', 'latitude': 'latitude', 'Country': 'Country', 'Region': 'Region', 'Sub Region': 'Sub Region', });
...
lyr_SierraLeonePlan_3.set('fieldImages', {'fid': '', 'Location': '', 'No of Racks': '', 'review': '', 'power available': '', 'Station ID': '', 'longitude': '', 'latitude': '', 'Country': '', 'Region': '', 'Sub Region': '', });
